...
# translation
SOURCES = chainagetool.py __init__.py world_engine.py world_enginedialog.py ui_world_engine.py  
#TRANSLATIONS = i18n/qchainage_en.ts
TRANSLATIONS = i18n/world_engine_pt_PT.ts i18n/world_engine_pt_BR.ts

# global

PLUGINNAME = world_engine

PY_FILES = world_engine.py world_enginedialog.py __init__.py chainagetool.py

EXTRAS = img/hslLogo.png metadata.txt

UI_FILES = ui_world_engine.py
